...
func main() {
	args := os.Args
	//args := strings.Split(`D:\code\work\bat\tools\goproto\goproto.exe D:\code\work\bat\cloud-platform\iot-proto\protos\gen\iot_app_oem\oem_app_assist_release_market_service.gen.proto`, " ")
	...
	//TODO 替换文件内容，将文件中的_ "/api" 替换为空
	//protoGoFile := fmt.Sprintf(`%s\protosService\%s.pb.go`, fileDir2, prefixName)
...
//有效
//protoc --proto_path=D:/code/work/bat/cloud-platform/tool/mysql-to-service/gen/proto/ --micro_out=D:/code/work/bat/cloud-platform/tool/mysql-to-service/protosService --go_out=D:/code/work/bat/cloud-platform/tool/mysql-to-service/protosService open_auth_quantity_model.gen.proto

//对比
//protoc --proto_path=D:/code/work/bat/cloud-platform/tool/mysql-to-service/gen/proto/ --micro_out=D:/code/work/bat/cloud-platform/tool/mysql-to-service/protosService --go_out=D:/code/work/bat/cloud-platform/tool/mysql-to-service/protosService open_auth_quantity_model.gen.proto

//protoc --proto_path=D:\\code\\work\\bat\\cloud-platform\\tool\\mysql-to-service\\gen\\proto --micro_out=D:\\code\\work\\bat\\cloud-platform\\tool\\mysql-to-service\\protosService --go_out=D:\\code\\work\\bat\\cloud-platform\\tool\\mysql-to-service\\protosService open_auth_quantity_model.gen.proto
